/**
    ...
    @version 3.1.0
    @author Ryan Comerford <https://ryancomerford.me>
...
if( !ES6Support ) {
	let errorText = "Insufficient support for ES6 (ECMAScript 2015). Please update your browser.";
...
function pageination(elementName, {
	...
	const _handleResize = e => {
		...
		resizeTimer = setTimeout(nestedHandleResize, resizeTimerThreshold);
	...
	if( !successfullyAddedEventListeners ) log(["Error initialising event listeners."], "error");
